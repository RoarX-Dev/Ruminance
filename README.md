# Ruminance
A zero-setup Research engine  (RAG from multiple sources + local NLP in pure js),included with A local Deterministic AI synthesis using BM25, Cosine simmilarity etc. Its Experimental and not serious, *still being worked on*!
